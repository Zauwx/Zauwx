...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      <h4>☁️ Plateforme d'hébergement (closed source)</h4>
      <p>Projet personnel d'envergure structuré comme un produit : CI/CD GitHub Actions, provisioning automatisé sur VPS, orchestration du cycle de vie des services via API, démarche itérative et documentation maintenue.</p>
      <p><code>CI/CD</code> <code>IaC</code> <code>API</code> <code>VPS</code></p>
    </td>
    <td width="50%" valign="top">
